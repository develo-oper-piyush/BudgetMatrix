			...
			<div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
				<section className="rounded-3xl border border-amber-200 bg-white/80 p-6 shadow-sm md:p-8">
					...
					<p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
						Budget Matrix is built to make personal finance simple,
						practical, and consistent. The goal is to help users
						understand where money goes and make smarter choices
						each month.
					</p>
				</section>
				...
				<section className="grid grid-cols-1 gap-4 md:grid-cols-3">
					<div className="rounded-2xl border border-amber-200 bg-amber-100/70 p-5 shadow-sm transition-all duration-100 hover:shadow-md">
						...
						<p className="mt-2 text-sm text-amber-700">
							Help users build confidence through clear budgeting
							and simple tracking.
						</p>
					</div>
					<div className="rounded-2xl border border-violet-200 bg-violet-100/70 p-5 shadow-sm transition-all duration-100 hover:shadow-md">
						...
						<p className="mt-2 text-sm text-violet-700">
							Clean interface, relevant insights, and features
							that solve daily money tasks.
						</p>
					</div>
					<div className="rounded-2xl border border-amber-200 bg-amber-100/70 p-5 shadow-sm transition-all duration-100 hover:shadow-md">
						<h2 className="text-lg font-gilroy-bold text-amber-800">
						...
						<p className="mt-2 text-sm text-amber-700">
							Clarity, control, and long-term financial habits for
							every user.
						</p>
					</div>
				</section>
