      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <section className="rounded-3xl border border-amber-200 bg-white/80 p-6 shadow-sm md:p-8">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600 sm:text-base">
            Have a question, suggestion, or feature request? Reach out and we
        ...
        <section className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border border-amber-200 bg-white/85 p-6 shadow-sm lg:col-span-2">
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-3">
              ...
              <button
                type="submit"
                className="cursor-pointer rounded-xl bg-violet-500 px-5 py-2.5 font-gilroy-md text-white transition hover:bg-violet-600"
              >
                Send Message
              </button>
            </form>
